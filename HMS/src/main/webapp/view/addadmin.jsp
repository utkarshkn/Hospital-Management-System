	...
	<nav class="navbar navbar-light"
		...
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link"
				href="/getadminloginPage" style="font-size: 20px;">Back To Login<span
					...
					<form action="addadmin" method="post">
						<div class="form-group">
							<label for="formGroupExampleInput">First Name</label> <input
								...
								id="formGroupExampleInput" placeholder="Enter First Name"
								required="required" autocomplete="off">
						</div>
						<div class="form-group">
							<label for="formGroupExampleInput">Last Name</label> <input
								type="text" name="last_name" class="form-control"
								id="formGroupExampleInput" placeholder="Enter Last Name"
								required="required" autocomplete="off">
						</div>
						<div class="form-group">
